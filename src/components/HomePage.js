...
const HomePage = ({ isUserLoggedIn }) => {
  ...
  const handleClubClick = async (clubName) => {
    ...
    if (isUserLoggedIn) {
      try {
        const response = await axios.post('http://localhost:3000/clubpage', { club: clubName });
      ...
      <div className='main-container'>
        ...
        <div className='options-container'>
         ...
         <div className='club' onClick={() => handleClubClick('Red Cross')}>
          ...
          <div className='club' onClick={() => handleClubClick('Science Club')}>
            <div className='club-link'>
              <h3>Science Club</h3>
            </div>
          </div>

          <div className='club' onClick={() => handleClubClick('Commerce Club')}>
            <div className='club-link'>
              <h3>Commerce Club</h3>
            </div>
          </div>
          ...
          <div className='club' onClick={() => handleClubClick('RangerRovers')}>
            <div className='club-link'>
              <h3>RangerRovers</h3>
            </div>
          </div>
